        ...
        <div class="border-t border-t-gray-300">
          <div class="p-4">
            <div class="flex items-center">
              <img :src="user.image" class="rounded-full ml-1 min-w-[45px] max-h-[45px]" />
              <div class="ml-4">
            ...
            <div class="mt-5 max-h-[55px] overflow-auto">
              <textarea v-model="form.text" placeholder="What's on your mind?" cols="30" rows="5" class="w-full border-0 mt-4 focus:ring-0 text-[20px]" />
