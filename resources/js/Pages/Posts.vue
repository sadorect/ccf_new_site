...
defineProps({ posts: Object, likes: Object})
                    ...
                    <div class="max-w-[340px] min-w-[250px] mx-auto pt-4">
                        ...
                        <div class="h-[calc(100vh-115px)] overflow-auto pt-2">
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                ...
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Ayodele Adeoye</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/88/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Esther Adeoye</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/89/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Samuel Ganiu</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/90/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Foluke Omojola</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/140/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Temitayo David</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/141/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Ekpereamaka Sunday</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/142/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Christiana David</div>
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/143/300/320" />
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Adekunle Adeoni</div>
                            </div>
